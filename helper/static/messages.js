function authHandler(typeProp) {
  const authObj = {
    ...
    INTERACTION_ADDED: "Interaction added successfully.",
    INTERACTION_UPD: "Interaction updated successfully.",
    INTERACTION_NOT_EXISTS: "Interaction value not exists, please try again.",
    INTERACTION_ADD_FAILED: "Interaction added failed.",
    INTERACTION_DELETED: "Interaction deleted successfully.",
    FAILED_DELETE_INTERACTION: "Interaction deleted failed.",
    DUPLICATE_INTERACTION_EXISTS: "Interaction already exists.",
    INTERACTION_UPD_FAILED: "Interaction update failed.",
    INTERACTION_ACTIVATED: "Interaction activated successfully.",
    INTERACTION_INACTIVE: "Interaction deactivated successfully.",
    ...
    DUPLICATE_PROPERTY_EXISTS:
      "Property value already exists, please try another value.",
    ...
    DUPLICATE_CONTACT_EXISTS:
      "Contact value already exists, please try another value.",
    ...
    // User
    DUPLICATE_USER_EXISTS:
      "User value already exists, please try another value.",
